...
<body class="index-page">
  ...
  <header id="header" class="header dark-background d-flex flex-column">
    ...
    <div class="profile-img">
      <img src="<?php echo $user_img?>" alt="User Image" class="img-fluid rounded-circle">
    </div>

    <a href="#" class="logo d-flex align-items-center justify-content-center">
      <h1 class="sitename"><?php echo $user_name?></h1>
    </a>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <img src="<?php echo $user_img?>" alt="User Image" data-aos="fade-in" class="">

      <div class="container" data-aos="fade-up" data-aos-delay="100">
        <h2><?php echo $user_name?></h2>
        <p>I'm <span class="typed" data-typed-items="Freelancer, <?php echo $user_name?>"></span><span class="typed-cursor typed-cursor--blink" aria-hidden="true"></span><span class="typed-cursor typed-cursor--blink" aria-hidden="true"></span></p>
      </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="<?php echo $user_img?>" class="img-fluid" alt="User Image">
          </div>
          <div class="col-lg-8 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span><?php echo $user_dob?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span><?php echo $user_cell?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span><?php echo $user_address?></span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span><?php echo $user_email?></span></li>
