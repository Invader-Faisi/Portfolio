    ...
    private function personalInformation($action) {
        ...
        if($action == 'addPersonalInfo'){
            $response = $this->db->addPersonalInfo(
                ...
                $user_age, $user_gender, $user_img, $user_social_fb, $user_social_tw,
                $user_social_in, $user_address, $user_cell
            );
            echo json_encode(['message' => $response]);
        }
    ...
    private function aboutInformation($action) {
        ...
        if($action == 'addAboutInfo')
        {
            ...
            $result = $this->db->Skills($skills, $skills_rating, $todo)
                ...
                && $this->db->Profession($user_professional_desig, $user_professional_from,
                    $user_professional_to, $user_professional_institute, $user_professional_exp,$todo)
